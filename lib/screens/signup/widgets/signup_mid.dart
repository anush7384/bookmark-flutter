...
import 'package:bookmark/screens/signup/widgets/terms.dart';
        ...
        child: Container(
            ...
            child: Column(children: [
              Padding(
                ...
                child: CustomTextfield(hintText: 'Name', obscure: false, controller: nameController,),
              ),
              Padding(
                padding: const EdgeInsets.only(bottom:20.0),
                child: CustomTextfield(hintText: 'Email', obscure: false, controller: emailController,),
              ),
              Padding(
                padding: const EdgeInsets.only(bottom:15.0),
                child: CustomTextfield(hintText: 'Password', obscure: true, controller: passwordController,),
              ),
              const Terms(),
